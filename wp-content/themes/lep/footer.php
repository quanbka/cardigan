<footer class="footer   ">
	...
	<div class="title-expand visible-xs text-center">
		<a class="btn-fter" data-toggle="collapse" href="#fter-content" role="button" aria-expanded="true" aria-controls="fter-content">
					...
					<div class="footer-col footer-block">
						...
						<div class="footer-content toggle-footer">
							<ul>
								...
								<li class="item">
									<a href="/pages/chinh-sach-bao-mat-1" title="Chính sách bảo mật">Chính sách bảo mật</a>
								</li>
								...
								<li class="item">
									<a href="/pages/chinh-sach-mua-hang" title="Chính sách mua hàng">Chính sách mua hàng</a>
								</li>
...
<div style="position: fixed; right: 20px; bottom: 20px; z-index: 100;">
    ...
    <a href="http://zalo.me/0368750618" target="_blank">
    ...
    <a href="http://m.me/aodongphuc4mua" target="_blank">
