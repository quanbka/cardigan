		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='/200000258383/1000664579/14/no_image.jpg?v=728'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','/200000258383/1000664579/14/no_image.jpg?v=728').attr('alt', product.url);
	} else {
